        ...
        products: [
          {
            ...
            image: IMG + 'sweet-tea.jpg?v=3',
            meta: '1 gallon',
          },
          {
            name: 'Unsweet Tea',
            value: 'Gallon unsweet tea',
            image: IMG + 'unsweet-tea.jpg?v=3',
            meta: '1 gallon',
          },
          {
            name: 'Pepsi',
            value: '12-pack Pepsi',
            image: IMG + 'pepsi-pack.jpg?v=3',
            meta: '12-pack',
          },
          {
            name: 'Diet Pepsi',
            value: '12-pack Diet Pepsi',
            image: IMG + 'diet-pepsi-pack.jpg?v=3',
            meta: '12-pack',
          },
          {
            name: 'Mountain Dew',
            value: '12-pack Mountain Dew',
            image: IMG + 'mountain-dew-pack.jpg?v=3',
            meta: '12-pack',
          },
          {
            name: 'Sierra Mist',
            value: '12-pack Sierra Mist',
            image: IMG + 'sierra-mist-pack.jpg?v=3',
            meta: '12-pack',
          },
        ],
      },
