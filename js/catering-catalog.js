 ...
 * Menu-format rows that preserve the existing checkbox/cart form contract.
 */
(function () {
  'use strict';
    ...
    groups: [
      {
        ...
        note: 'Same burgers as the dine-in menu. Add box lunch or bundle details in the notes.',
        products: [
          {
          ...
          {
            name: 'Garbage Burger',
            value: 'Catering garbage burgers',
            image: IMG + 'garbage-burger.jpg?v=3',
            meta: 'Per dozen',
          },
          {
      ...
      },
      {
        ...
        products: [
          ...
          },
          {
            ...
            meta: 'House salad with grilled chicken',
          },
          {
            name: 'Caesar Salad',
            value: 'Caesar Salad',
      ...
      },
      {
        ...
        products: [
          {
            name: 'Half Tray Churros',
            value: 'Half tray Churros',
            image: IMG + 'churros.jpg',
            meta: 'Half tray, cinnamon and sugar',
          },
          {
            name: 'Full Tray Churros',
            value: 'Full tray Churros',
            image: IMG + 'churros.jpg',
            meta: 'Full tray, cinnamon and sugar',
          },
          {
            name: 'Half Tray Beignets',
            value: 'Half tray Beignets',
            image: '../assets/images/menu-food/dessert.png',
            meta: 'Half tray, powdered sugar',
          },
          {
            name: 'Full Tray Beignets',
        ...
        products: [
          {
            ...
            image: IMG + 'sweet-tea.jpg?v=4',
            meta: '1 gallon',
          },
          {
            name: 'Gallon Unsweet Tea',
            value: 'Gallon unsweet tea',
            image: IMG + 'unsweet-tea.jpg?v=4',
            meta: '1 gallon',
          },
          {
            name: '12-Pack Pepsi',
            value: '12-pack Pepsi',
            image: IMG + 'pepsi-pack.jpg?v=4',
            meta: '12-pack',
          },
          {
            name: '12-Pack Diet Pepsi',
            value: '12-pack Diet Pepsi',
            image: IMG + 'diet-pepsi-pack.jpg?v=4',
            meta: '12-pack',
          },
          {
            name: '12-Pack Mountain Dew',
            value: '12-pack Mountain Dew',
            image: IMG + 'mountain-dew-pack.jpg?v=4',
            meta: '12-pack',
          },
          {
            name: '12-Pack Sierra Mist',
            value: '12-pack Sierra Mist',
            image: IMG + 'sierra-mist-pack.jpg?v=4',
            meta: '12-pack',
          },
        ],
      },
  ...
  function packageCard(p) {
    ...
    return (
      '<label class="p-card p-card--lg bundle-card cat-package-row' +
      vip +
      '">' +
    ...
    root.innerHTML =
      ...
      .map(function (g) {
        ...
        return (
          ...
          '<div><h3 class="cat-group-title">' +
          esc(g.title) +
          '</h3>' +
          (g.note ? '<p class="cat-group-note">' + esc(g.note) + '</p>' : '') +
          '</div>' +
          '<span class="cat-group-count">' +
          g.products.length +
          ' options</span>' +
          '</div>' +
          '<div class="' +
